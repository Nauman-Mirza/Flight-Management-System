...
$sql = "SELECT b.id, b.flightnum, f.status, f.origin, f.dest, f.date, f.arr_time, f.dep_time FROM bookings b INNER JOIN flight f ON b.flightnum = f.flightnum WHERE b.passengerid = '$user_id' and f.status='finished'";
